...
function getCalculatedProps(props, childComponents) {
  ...
  var categories = props.categories || victory_core__WEBPACK_IMPORTED_MODULE_3__.getCategories(props, childComponents);
  var datasets = props.datasets || victory_core__WEBPACK_IMPORTED_MODULE_3__.getDataFromChildren(props);
  var domain = {
    x: victory_core__WEBPACK_IMPORTED_MODULE_3__.getDomain(lodash_assign__WEBPACK_IMPORTED_MODULE_0___default()({}, props, {
      categories: categories
    }), "x", childComponents),
    y: victory_core__WEBPACK_IMPORTED_MODULE_3__.getDomain(lodash_assign__WEBPACK_IMPORTED_MODULE_0___default()({}, props, {
      categories: categories
    }), "y", childComponents)
  };
...
function getChildren(props, childComponents, calculatedProps) {
  ...
  return childComponents.map(function (child, index) {
    ...
    var style = role === "voronoi" || role === "tooltip" || role === "label" ? child.props.style : victory_core__WEBPACK_IMPORTED_MODULE_3__.getChildStyle(child, index, calculatedProps);
...
VictoryGroup.propTypes = _objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_11__.baseProps, victory_core__WEBPACK_IMPORTED_MODULE_11__.dataProps, {
...
var VictoryGroupMemo = react__WEBPACK_IMPORTED_MODULE_4___default().memo(VictoryGroup, (react_fast_compare__WEBPACK_IMPORTED_MODULE_5___default()));
