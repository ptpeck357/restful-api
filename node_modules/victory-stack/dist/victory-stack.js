...
function getCalculatedProps(props, childComponents) {
  ...
  var domain = {
    x: victory_core__WEBPACK_IMPORTED_MODULE_4__.getDomain(lodash_assign__WEBPACK_IMPORTED_MODULE_2___default()({}, props, {
      categories: categories
    }), "x", children),
    y: victory_core__WEBPACK_IMPORTED_MODULE_4__.getDomain(lodash_assign__WEBPACK_IMPORTED_MODULE_2___default()({}, props, {
      categories: categories
    }), "y", children)
  };
...
function getChildren(props, childComponents, calculatedProps) {
  ...
  return childComponents.map(function (child, index) {
    ...
    var style = victory_core__WEBPACK_IMPORTED_MODULE_4__.getChildStyle(child, index, calculatedProps);
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/hooks.js");
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/common-props.js");
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-container/victory-container.js");
...
/* harmony import */ var victory_shared_events__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! victory-shared-events */ "../../victory-shared-events/es/victory-shared-events.js");
...
var VictoryStack = function (initialProps) {
  ...
  var _useAnimationState = (0,victory_core__WEBPACK_IMPORTED_MODULE_6__.useAnimationState)(),
  ...
  var calculatedProps = (0,_helper_methods__WEBPACK_IMPORTED_MODULE_8__.getCalculatedProps)(modifiedProps, childComponents);
  ...
  var container = react__WEBPACK_IMPORTED_MODULE_4___default().useMemo(function () {
    if (standalone) {
      var defaultContainerProps = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, containerComponent.props, containerProps);

      return react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(containerComponent, defaultContainerProps);
    }
  ...
  var previousProps = (0,victory_core__WEBPACK_IMPORTED_MODULE_6__.usePreviousProps)(initialProps);
  ...
  if (!lodash_isEmpty__WEBPACK_IMPORTED_MODULE_0___default()(events)) {
    return react__WEBPACK_IMPORTED_MODULE_4___default().createElement(victory_shared_events__WEBPACK_IMPORTED_MODULE_10__.default, {
      container: container,
      eventKey: eventKey,
      events: events,
...
VictoryStack.propTypes = _objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_11__.baseProps, {
  bins: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_3___default().arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([victory_core__WEBPACK_IMPORTED_MODULE_12__.nonNegative, prop_types__WEBPACK_IMPORTED_MODULE_3___default().instanceOf(Date)])), victory_core__WEBPACK_IMPORTED_MODULE_12__.nonNegative]),
...
VictoryStack.defaultProps = {
  containerComponent: react__WEBPACK_IMPORTED_MODULE_4___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_13__.default, null),
...
var VictoryStackMemo = react__WEBPACK_IMPORTED_MODULE_4___default().memo(VictoryStack, (react_fast_compare__WEBPACK_IMPORTED_MODULE_5___default()));
...
/***/ "../../victory-core/es/victory-util/hooks.js":
/*!***************************************************!*\
  !*** ../../victory-core/es/victory-util/hooks.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function getDataFromChildren(props, childComponents) {
  ...
  var iteratee = function (child, childName, parent) {
    ...
    if (!_data__WEBPACK_IMPORTED_MODULE_12__.isDataComponent(child)) {
      ...
      child = parent ? react__WEBPACK_IMPORTED_MODULE_9___default().cloneElement(child, parent.props) : child;
...
function getDomain(props, axis, childComponents) {
  ...
  if (propsDomain) {
    ...
    var min = minDomain || _collection__WEBPACK_IMPORTED_MODULE_14__.getMinValue(_toConsumableArray(dataDomain).concat(_toConsumableArray(childDomain)));
    var max = maxDomain || _collection__WEBPACK_IMPORTED_MODULE_14__.getMaxValue(_toConsumableArray(dataDomain).concat(_toConsumableArray(childDomain)));
...
function getCategoryAndAxisStringsFromChildren(props, axis, childComponents) {
  ...
  return lodash_uniq__WEBPACK_IMPORTED_MODULE_4___default()(lodash_flatten__WEBPACK_IMPORTED_MODULE_6___default()(_toConsumableArray(categoryStrings).concat(_toConsumableArray(axisStrings))));
}
function getStringsFromChildren(props, childComponents) {
  ...
  return {
    x: lodash_uniq__WEBPACK_IMPORTED_MODULE_4___default()(lodash_flatten__WEBPACK_IMPORTED_MODULE_6___default()(_toConsumableArray(xStrings).concat(_toConsumableArray(dataStrings.x)))),
    y: lodash_uniq__WEBPACK_IMPORTED_MODULE_4___default()(lodash_flatten__WEBPACK_IMPORTED_MODULE_6___default()(_toConsumableArray(yStrings).concat(_toConsumableArray(dataStrings.y))))
  };
}
